var B = "top", T = "bottom", L = "right", $ = "left", Pt = "auto", ft = [B, T, L, $], Q = "start", ot = "end", ue = "clippingParents", Kt = "viewport", nt = "popper", le = "reference", Ft = /* @__PURE__ */ ft.reduce(function(t, e) {
...
function Ae(t) {
  ...
  Object.keys(e.elements).forEach(function(r) {
    ...
    !k(i) || !V(i) || (Object.assign(i.style, n), Object.keys(a).forEach(function(p) {
      var s = a[p];
...
function Ee(t) {
  ...
  return Object.assign(e.elements.popper.style, r.popper), e.styles = r, e.elements.arrow && Object.assign(e.elements.arrow.style, r.arrow), function() {
    Object.keys(e.elements).forEach(function(n) {
      ...
      !k(a) || !V(a) || (Object.assign(a.style, s), Object.keys(i).forEach(function(o) {
        a.removeAttribute(o);
      }));
    });
  };
...
function _(t, e, r) {
  ...
  e && k(t) && (a = t.offsetWidth > 0 && Z(n.width) / t.offsetWidth || 1, i = t.offsetHeight > 0 && Z(n.height) / t.offsetHeight || 1);
  var p = J(t) ? S(t) : window, s = p.visualViewport, o = !Zt() && r, c = (n.left + (o && s ? s.offsetLeft : 0)) / a, f = (n.top + (o && s ? s.offsetTop : 0)) / i, h = n.width / a, y = n.height / i;
  return {
    width: h,
    height: y,
    top: f,
...
function je(t) {
  ...
  var a = yt(t);
  for (Dt(a) && (a = a.host); k(a) && ["html", "body"].indexOf(V(a)) < 0; ) {
    var i = N(a);
...
function pt(t) {
  for (var e = S(t), r = qt(t); r && De(r) && N(r).position === "static"; )
    r = qt(r);
...
function $e(t) {
  ...
  if (!(!i || !p)) {
    var h = Be(a.padding, r), y = jt(i), u = o === "y" ? B : $, w = o === "y" ? T : L, d = r.rects.reference[f] + r.rects.reference[o] - p[o] - r.rects.popper[f], v = p[o] - r.rects.reference[o], b = pt(i), O = b ? o === "y" ? b.clientHeight || 0 : b.clientWidth || 0 : 0, A = d / 2 - v / 2, l = h[u], m = O - y[f] - h[w], g = O / 2 - y[f] / 2 + A, x = at(l, g, m), D = o;
...
function Xt(t) {
  ...
  if (c) {
    ...
    if (g === S(r) && (g = q(r), N(g).position !== "static" && s === "absolute" && (x = "scrollHeight", D = "scrollWidth")), g = g, a === B || (a === $ || a === L) && i === ot) {
      l = T;
...
function We(t) {
  var e = t.state, r = t.instance, n = t.options, a = n.scroll, i = a === void 0 ? !0 : a, p = n.resize, s = p === void 0 ? !0 : p, o = S(e.elements.popper), c = [].concat(e.scrollParents.reference, e.scrollParents.popper);
...
function Bt(t) {
  var e = S(t), r = e.pageXOffset, n = e.pageYOffset;
  return {
    scrollLeft: r,
    scrollTop: n
  };
...
function Fe(t, e) {
  var r = S(t), n = q(t), a = r.visualViewport, i = n.clientWidth, p = n.clientHeight, s = 0, o = 0;
  if (a) {
...
function ne(t) {
  return ["html", "body", "#document"].indexOf(V(t)) >= 0 ? t.ownerDocument.body : k(t) && Ct(t) ? t : ne(yt(t));
}
function it(t, e) {
  var r;
  e === void 0 && (e = []);
  var n = ne(t), a = n === ((r = t.ownerDocument) == null ? void 0 : r.body), i = S(n), p = a ? [i].concat(i.visualViewport || [], Ct(n) ? n : []) : n, s = e.concat(p);
  return a ? s : (
...
function Ie(t) {
  var e = it(yt(t)), r = ["absolute", "fixed"].indexOf(N(t).position) >= 0, n = r && k(t) ? pt(t) : t;
...
function Ge(t) {
  ...
  if (!e.modifiersData[n]._skip) {
    for (var a = r.mainAxis, i = a === void 0 ? !0 : a, p = r.altAxis, s = p === void 0 ? !0 : p, o = r.fallbackPlacements, c = r.padding, f = r.boundary, h = r.rootBoundary, y = r.altBoundary, u = r.flipVariations, w = u === void 0 ? !0 : u, d = r.allowedAutoPlacements, v = e.options.placement, b = H(v), O = b === v, A = o || (O || !w ? [mt(v)] : Ue(v)), l = [v].concat(A).reduce(function(K, F) {
      ...
      var j = l[E], M = H(j), R = tt(j) === Q, X = [B, T].indexOf(M) >= 0, I = X ? "width" : "height", C = st(e, {
        placement: j,
        boundary: f,
        rootBoundary: h,
        altBoundary: y,
...
function ar(t) {
  ...
  if (g) {
    if (i) {
      var R, X = l === "y" ? B : $, I = l === "y" ? T : L, C = l === "y" ? "height" : "width", W = g[l], ct = W + v[X], Y = W - v[I], ut = u ? -D[C] / 2 : 0, bt = O === Q ? x[C] : D[C], et = O === Q ? -D[C] : -x[C], lt = e.elements.arrow, K = u && lt ? jt(lt) : {
        width: 0,
        height: 0
      }, F = e.modifiersData["arrow#persistent"] ? e.modifiersData["arrow#persistent"].padding : te(), rt = F[X], vt = F[I], z = at(0, x[C], K[C]), wt = A ? x[C] / 2 - ut - z - rt - E.mainAxis : bt - z - rt - E.mainAxis, ie = A ? -x[C] / 2 + ut + z + vt + E.mainAxis : et + z + vt + E.mainAxis, xt = e.elements.arrow && pt(e.elements.arrow), oe = xt ? l === "y" ? xt.clientTop || 0 : xt.clientLeft || 0 : 0, St = (R = j == null ? void 0 : j[l]) != null ? R : 0, se = W + wt - St - oe, fe = W + ie - St, kt = at(u ? gt(ct, se) : ct, W, u ? G(Y, fe) : Y);
      g[l] = kt, M[l] = kt - W;
    }
    if (s) {
      var Tt, pe = l === "x" ? B : $, ce = l === "x" ? T : L, U = g[m], dt = m === "y" ? "height" : "width", Lt = U + v[pe], Mt = U - v[ce], Ot = [B, $].indexOf(b) !== -1, Wt = (Tt = j == null ? void 0 : j[m]) != null ? Tt : 0, Ht = Ot ? Lt : U - x[dt] - D[dt] - Wt + E.altAxis, Vt = Ot ? U + x[dt] + D[dt] - Wt - E.altAxis : Mt, Nt = u && Ot ? Re(Ht, U, Vt) : at(u ? Ht : Lt, U, u ? Vt : Mt);
      g[m] = Nt, M[m] = Nt - U;
    }
    e.modifiersData[n] = M;
  }
...
function pr(t, e, r) {
  r === void 0 && (r = !1);
  var n = k(e), a = k(e) && fr(e), i = q(e), p = _(t, a, r), s = {
    scrollLeft: 0,
    scrollTop: 0
  }, o = {
    x: 0,
  ...
  Ct(i)) && (s = sr(e)), k(e) ? (o = _(e, !0), o.x += e.clientLeft, o.y += e.clientTop) : i && (o.x = $t(i))), {
...
var hr = [He, rr, Me, Pe, tr, Je, ir, Se, Qe], mr = /* @__PURE__ */ dr({
  defaultModifiers: hr
});
export {
  ye as afterMain,
  ...
  Se as arrow,
  Pt as auto,
  ft as basePlacements,
  me as beforeMain,
  ve as beforeRead,
  be as beforeWrite,
  T as bottom,
  ue as clippingParents,
  Me as computeStyles,
  mr as createPopper,
  st as detectOverflow,
  ot as end,
  He as eventListeners,
  Je as flip,
  Qe as hide,
  $ as left,
  ge as main,
  Oe as modifierPhases,
  tr as offset,
  Qt as placements,
  nt as popper,
  dr as popperGenerator,
  rr as popperOffsets,
  ir as preventOverflow,
  de as read,
  le as reference,
  L as right,
  Q as start,
  B as top,
  Ft as variationPlacements,
  Kt as viewport,
  we as write
};
//# sourceMappingURL=index-B54dWoxf.js.map
